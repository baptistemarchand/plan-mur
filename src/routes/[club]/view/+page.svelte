...
<div class="flex flex-wrap gap-x-12 py-4">
  ...
  <div>
    ...
    <Breakdown
      ...
      sortBy={byLine}
    />
    <a href="/{club.slug}/ouvertures" class="text-xl border border-black rounded px-4 py-2 inline-block ml-3 mt-4">
      OUVERTURES
    </a>
...
<div>
  <a href="/{club.slug}/pdf" class="text-xl border border-black rounded px-4 py-2 inline-block ml-2 my-3"> PDF </a>
</div>
